...
let
  sources = {
    ...
    "@types/node-22.10.10" = {
      ...
      version = "22.10.10";
      src = fetchurl {
        url = "https://registry.npmjs.org/@types/node/-/node-22.10.10.tgz";
        sha512 = "X47y/mPNzxviAGY5TcYPtYL8JsY3kAq2n8fMmKoRCxq/c4v4pyGNCzM2R6+M5/umG4ZfHuT+sgqDYqWc9rJ6ww==";
      };
    };
    "@types/shimmer-1.2.0" = {
